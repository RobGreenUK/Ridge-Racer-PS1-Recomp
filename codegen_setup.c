...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "RidgeRacer",
    .project_root_env = "RIDGERACERRECOMP_PROJECT_ROOT",
    .build_dir_env = "RIDGERACERRECOMP_BUILD_DIR",
    .force_setup_env = "RIDGERACERRECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS-943.00_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "RidgeRacer_Recompiled",
    .prepare_note =
